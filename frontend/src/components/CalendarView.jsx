                                        ...
                                        {isEditing ? (
                                            ...
                                            <>
                                                <div className="flex items-center justify-between gap-1">
                                                    <div
                                                        className={`truncate flex-grow cursor-pointer ${task.completed ? 'line-through text-gray-500' : 'text-gray-200'}`}
                                                ...
                                                {isShowingNotes && (
                                                    <div className="mt-1 p-1 bg-black/30 rounded border border-white/5 text-[8px] text-gray-400 italic break-words">
                                                        {task.notes || "No notes."}
                                                    </div>
                                                )}
                                            </>
